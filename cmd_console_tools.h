...
/* 定义位置 */
#define Sleep_time         20//动画的延迟时间为120ms
#define START_MAP          5//棋盘的最左边开始的位置
#define MAX                500//移动过程中路径的最大值 
#define SIZE4              25//cmd窗口的行数
#define SIZE5              80 //cmd窗口的列数
#define PLACE_1            40//计分板的位置的最左边
#define PLACE_2            50//标记位置
#define PLACE_3            60//标记位置“消除”
#define ZITI               28//字体大小
